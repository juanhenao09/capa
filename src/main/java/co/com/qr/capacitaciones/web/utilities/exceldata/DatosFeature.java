package co.com.qr.capacitaciones.web.utilities.exceldata;
  ...
  private static List<String> setExcelDataToFeature(File featureFile)
    ...
    try (BufferedReader buffReader =
      ...
      while ((data = buffReader.readLine()) != null) {
        ...
        if (foundHashTag) {
          excelData = new co.com.qr.capacitaciones.web.utilities.exceldata.LectorExcel().getData(excelFilePath, sheetName, idCaso);
